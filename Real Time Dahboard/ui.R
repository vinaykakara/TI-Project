                  ...
                  tabItems(
                    ...
                    tabItem(tabName = "dashboard",
                            tabsetPanel(
                              ...
                              tabPanel(title = "Guide Plate",icon = icon("user"),box(title = "Guide Plate",width = 7, status = "info",solidHeader = TRUE,collapsible = TRUE, bubblesOutput("Bubble1",width = "100%",height = 500)),
                                       box(title = "Guide Plate ",width = 5, status = "info",solidHeader = TRUE,collapsible = TRUE, tableOutput("Real1")),
                                       box(title = "Parts Produced",width = 5, status = "info",solidHeader = TRUE,collapsible = TRUE,dataTableOutput("table2"))),
                              
                              tabPanel(title = "PAWL",icon = icon("user"),box(title = "PAWL",width = 7, status = "info",solidHeader = TRUE,collapsible = TRUE, bubblesOutput("Bubble2",width = "100%",height = 500)),
                                       box(title = "PAWL",width = 5, status = "info",solidHeader = TRUE,collapsible = TRUE, tableOutput("Real2")))
                    ...
                    tabItem(tabName = "guide",
                            tabsetPanel(
                              tabPanel("Guide Plate Data (Hourly)",radioButtons("radio","Type of Barchart:",choices = c("Stack"="1","Dodge"="2"),inline = TRUE),
                                       ...
                                       box(title = "Guide Plate - H",width = 8, status = "info",solidHeader = TRUE,collapsible = TRUE, plotlyOutput("Hour",width = "100%",height = 500)),
                                       box(title = "Guide Plate",width = 4, status = "info",solidHeader = TRUE,collapsible = TRUE, dataTableOutput("tbl1"))),
                    ...
                    tabItem(tabName = "pawl",
                            tabsetPanel(
                              tabPanel("PAWL Data (Hourly)",radioButtons("p1","Type of Barchart:",choices = c("Stack"="1","Dodge"="2"),inline = TRUE),
                                       ...
                                       box(title = "PAWL (Hourly)",width = 8, status = "info",solidHeader = TRUE,collapsible = TRUE, plotlyOutput("Hour1",width = "100%",height = 500)),
                                       box(title = "PAWL",width = 4, status = "info",solidHeader = TRUE,collapsible = TRUE, dataTableOutput("tbl2"))),
                    ...
                    tabItem(tabName = "gd1",
                            tabsetPanel(
                              tabPanel("Guide Plate - Left (Hourly)",radioButtons("l1","Type of Barchart:",choices = c("Stack"="1","Dodge"="2"),inline = TRUE),
                                       ...
                                       box(title = "Guide Plate-GD1 - H",width = 8, status = "info",solidHeader = TRUE,collapsible = TRUE, plotlyOutput("Hour2",width = "100%",height = 500)),
                                       box(title = "Guide Plate (GD1)",width = 4, status = "info",solidHeader = TRUE,collapsible = TRUE, dataTableOutput("tbl3"))),
                    ...
                    tabItem(tabName = "gd2",
                            tabsetPanel(
                              tabPanel("Guide Plate - Right (Hourly)",radioButtons("r1","Type of Barchart:",choices = c("Stack"="1","Dodge"="2"),inline = TRUE),
                                       ...
                                       box(title = "Guide Plate-GD2 - H",width = 8, status = "info",solidHeader = TRUE,collapsible = TRUE, plotlyOutput("Hour3",width = "100%",height = 500)),
                                       box(title = "Guide Plate (GD2)",width = 4, status = "info",solidHeader = TRUE,collapsible = TRUE, dataTableOutput("tbl4"))),
                    ...
                    tabItem(tabName = "o",box(title = "Guide Plate (GD1 & GD2)",width = 14, status = "info",solidHeader = TRUE,collapsible = TRUE,dataTableOutput("table")),
                            box(title = "Guide Plate (Combinations)",width = 14,status = "info",solidHeader = TRUE,collapsible = TRUE, dataTableOutput("table1"))),
                    ...
                    tabItem(tabName = "m",box(title = "Guide Plate (Tolerance Band)",width = 6, status = "info",solidHeader = TRUE,collapsible = TRUE,dataTableOutput("table3")),
                            box(title = "PAWL (Tolerance Band)",width = 6, status = "info",solidHeader = TRUE,collapsible = TRUE,dataTableOutput("table4"),valueBoxOutput("x")))
